...
Class.create("PixlrEditor", AbstractEditor, {
	...
	open : function($super, userSelection)
	{
		...
		var src = ajxpBootstrap.parameters.get('ajxpServerAccess')+"&get_action=post_to_server&file=" + base64_encode(fName) + "&parent_url=" + base64_encode([document.location.protocol, '//', document.location.host, document.location.pathname].join(''));
